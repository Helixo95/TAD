...
SELECT * FROM ROLE_TAB_PRIVS WHERE ROLE = 'C##OPTI_READWRITE';
SELECT * FROM ROLE_TAB_PRIVS WHERE ROLE = 'C##ORIGIN_READONLY';

SELECT * FROM DBA_ROLE_PRIVS WHERE GRANTEE = 'C##IMPROVEMENT';
SELECT * FROM DBA_ROLE_PRIVS WHERE GRANTEE = 'C##WITNESS';
